...
Egenskap: Utled tidligste endring av vedtaksperiode

  Regel: Endring av sluttdato skal gi tidligste endring dato som tidligste av ny og gammel fom
  ...
  Regel: Endring av startdato skal gi tidligste endring dato som tidligste av ny og gammel tom
  ...
  Regel: Nye målgrupper skal gi tidligste endring startdato på ny periode
  ...
  Regel: Sletting av målgruppe skal gi tidligste endring lik fom på slettet periode
  ...
  Regel: Hvis aktivitet eller målgruppetype endres skal tidligste endring være starten på endret periode
