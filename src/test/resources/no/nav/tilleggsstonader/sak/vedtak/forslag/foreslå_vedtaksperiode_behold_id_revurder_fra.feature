...
Egenskap: Forslag av vedtaksperioder med behold id for å kunne bruke i revurdering med tidligsteEndring
  ...
  Scenario: Revurder fra FOM på tidligere vedtaksperiode
    ...
    Når forslag til vedtaksperioder behold id lages tidligsteEndring=01.03.2023
  ...
  Scenario: Revurder fra midt i tidligere vedtaksperiode
    ...
    Når forslag til vedtaksperioder behold id lages tidligsteEndring=10.03.2023
