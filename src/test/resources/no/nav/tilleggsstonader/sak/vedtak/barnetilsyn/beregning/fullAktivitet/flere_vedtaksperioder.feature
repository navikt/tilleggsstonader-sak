...
Egenskap: Beregning - Flere vedtaksperioder med full aktivitet
  ...
  Scenario: Flere vedtaksperioder innenfor samme måned - en aktivitet:
    Gitt følgende vedtaksperioder
      ...
      | 01.01.2023 | 11.01.2023 | UTDANNING | ENSLIG_FORSØRGER    |
      | 12.01.2023 | 31.01.2023 | UTDANNING | NEDSATT_ARBEIDSEVNE |
    ...
    Gitt følgende målgrupper
      | Fom        | Tom        | Målgruppe       |
      | 01.01.2023 | 11.01.2023 | OVERGANGSSTØNAD |
      | 12.01.2023 | 31.01.2023 | AAP             |
    ...
    Så forvent følgende vedtaksperiodeGrunnlag for: 01.2023
      ...
      | 01.01.2023 | 11.01.2023 | ENSLIG_FORSØRGER    | UTDANNING | 1                  | 8            |
      | 12.01.2023 | 31.01.2023 | NEDSATT_ARBEIDSEVNE | UTDANNING | 1                  | 14           |

    Så forvent følgende beløpsperioder for: 01.2023
      | Dato       | Beløp | Målgruppe           |
      # dato skal egentligen være 01.01.2023 men er en søndag
      | 02.01.2023 | 236   | ENSLIG_FORSØRGER    |
      | 12.01.2023 | 413   | NEDSATT_ARBEIDSEVNE |
  ...
  Scenario: Flere vedtaksperioder innenfor samme måned - ulike aktiviteter:
    ...
    Gitt følgende vedtaksperioder
      | Fom        | Tom        | Aktivitet | Målgruppe           |
      | 01.01.2023 | 11.01.2023 | UTDANNING | ENSLIG_FORSØRGER    |
      | 12.01.2023 | 31.01.2023 | TILTAK    | NEDSATT_ARBEIDSEVNE |
    ...
    Så forvent følgende vedtaksperiodeGrunnlag for: 01.2023
      | Fom        | Tom        | Målgruppe           | Aktivitet | Antall aktiviteter | Antall dager |
      | 01.01.2023 | 11.01.2023 | ENSLIG_FORSØRGER    | UTDANNING | 1                  | 8            |
      | 12.01.2023 | 31.01.2023 | NEDSATT_ARBEIDSEVNE | TILTAK    | 1                  | 14           |
