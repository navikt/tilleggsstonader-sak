...
class LæremidlerBeregnUtilTest {
    ...
    private fun VedtaksperiodeBeregning.forLøpendeMåned() = VedtaksperiodeInnenforLøpendeMåned(fom = fom, tom = tom)

    private fun List<VedtaksperiodeBeregning>.forLøpendeMåned() = this.map { it.forLøpendeMåned() }
}
