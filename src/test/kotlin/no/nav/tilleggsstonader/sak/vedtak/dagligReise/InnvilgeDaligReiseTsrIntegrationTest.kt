...
class InnvilgeDaligReiseTsrIntegrationTest : IntegrationTest() {
    ...
    fun `innvilge revurdering daglig reise med gyldig tiltak`() {
        ...
        val vilkårsperioderFørstegangsbehandling =
            vilkårperiodeService.hentVilkårperioder(førstegangsbehandlingContext.behandlingId)
