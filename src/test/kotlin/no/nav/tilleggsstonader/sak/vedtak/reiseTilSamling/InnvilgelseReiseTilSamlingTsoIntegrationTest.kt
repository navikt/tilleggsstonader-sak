...
/**
 * Tester innvilgelse av reise til samling for tema **TSO**.
 * Se [InnvilgelseReiseTilSamlingTsrIntegrationTest] for tilsvarende test for tema TSR.
 */
class InnvilgelseReiseTilSamlingTsoIntegrationTest : IntegrationTest() {
    @Test
    fun `kan innvilge reise til samling offentlig transport - TSO`() {
