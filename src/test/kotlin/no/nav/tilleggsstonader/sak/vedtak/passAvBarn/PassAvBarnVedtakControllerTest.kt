...
class PassAvBarnVedtakControllerTest : CleanDatabaseIntegrationTest() {
    @Autowired
        ...
        val lagretDto =
            kall.vedtak
                .hentVedtak(
                    stønadstype = Stønadstype.BARNETILSYN,
                    behandlingId = behandling.id,
                ).expectOkWithBody<InnvilgelsePassAvBarnResponse>()
    ...
    fun `skal lagre og hente avslag`() {
        ...
        val lagretDto =
            kall.vedtak
                ...
                .expectOkWithBody<AvslagPassAvBarnDto>()
    ...
    fun `skal lagre og hente opphør med vedtaksperioder`() {
        ...
        val lagretDto =
            kall.vedtak
                ...
                .expectOkWithBody<OpphørPassAvBarnResponse>()
