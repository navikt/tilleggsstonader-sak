...
class VedtaksperiodePassAvBarnMapperTest {
    val periode1 =
    ...
    fun `skal slå sammen perioder hvis de er like og sammenhengende`() {
        val vedtaksperioder = VedtaksperiodePassAvBarnMapper.mapTilVedtaksperiode(listOf(beregningsresultat(periode1, periode2)))

        assertThat(vedtaksperioder).containsExactly(
            VedtaksperiodePassAvBarn(
                fom = periode1.fom,
                tom = periode2.tom,
    ...
    fun `skal slå sammen perioder tvers ulike måneder`() {
        ...
        val vedtaksperioder =
            VedtaksperiodePassAvBarnMapper.mapTilVedtaksperiode(
                listOf(
