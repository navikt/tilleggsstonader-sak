...
class HarIngenUtbetalingsperioderSomOverlapperFlereLøpendeUtgifterValideringTest {
    ...
    fun `verifiserer at feilmeldingen blir som forventet`() {
        assertThatThrownBy {
            ...
            Utbetalingsperioder som inneholder flere løpende utgifter:
            
            01.01.2025–31.01.2025 inneholder utgiftene:
              - 01.01.2025–31.01.2025 - en bolig (1000 kr)
              - 01.01.2025–31.01.2025 - to boliger (1000 kr)
            
            01.02.2025–28.02.2025 inneholder utgiftene:
              - 01.02.2025–28.02.2025 - en bolig (1000 kr)
              - 01.02.2025–28.02.2025 - to boliger (1000 kr)
            """.trimIndent(),
        )
    }

    private fun utbetalingsperiode(month: YearMonth): UtbetalingPeriode =
        UtbetalingPeriode(
            LøpendeMåned(
                fom = month.atDay(1),
    ...
    private fun utgift(month: YearMonth): UtgiftBeregningBoutgifter =
