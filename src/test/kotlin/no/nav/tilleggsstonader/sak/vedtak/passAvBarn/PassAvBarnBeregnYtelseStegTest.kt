...
import no.nav.tilleggsstonader.sak.vedtak.passAvBarn.beregning.PassAvBarnUtgiftService
...
class PassAvBarnBeregnYtelseStegTest {
    ...
    private val passAvBarnUtgiftService = mockk<PassAvBarnUtgiftService>(relaxed = true)
    private val opphørValideringService = mockk<OpphørValideringService>(relaxed = true)
    private val passAvBarnVedtaksperiodeValidingerService =
    ...
    val passAvBarnBeregningService =
        PassAvBarnBeregningService(
            ...
            vedtaksperiodeValidingerService = passAvBarnVedtaksperiodeValidingerService,
        )
    ...
    val steg =
        PassAvBarnBeregnYtelseSteg(
            beregningService = passAvBarnBeregningService,
    ...
    fun setUp() {
        ...
        every { passAvBarnUtgiftService.hentUtgifterTilBeregning(any()) } returns
