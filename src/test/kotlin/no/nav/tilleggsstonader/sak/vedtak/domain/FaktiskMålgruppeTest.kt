...
class FaktiskMålgruppeTest {
    ...
    inner class `skal mappe til rett type andel` {
        ...
        inner class `for tilsyn barn` {
            @Test
            fun `fra AAP`() {
                assertThat(FaktiskMålgruppe.AAP.tilTypeAndel(Stønadstype.BARNETILSYN)).isEqualTo(TypeAndel.TILSYN_BARN_AAP)
            }

            @Test
            fun `fra UFØRETRYGD`() {
                assertThat(FaktiskMålgruppe.UFØRETRYGD.tilTypeAndel(Stønadstype.BARNETILSYN)).isEqualTo(TypeAndel.TILSYN_BARN_AAP)
            }
            ...
            fun `fra OVERGANGSSTØNAD`() {
                assertThat(
                    FaktiskMålgruppe.OVERGANGSSTØNAD.tilTypeAndel(Stønadstype.BARNETILSYN),
            ...
            fun `fra OMSTILLINGSSTØNAD`() {
                assertThat(
                    FaktiskMålgruppe.OMSTILLINGSSTØNAD.tilTypeAndel(Stønadstype.BARNETILSYN),
        ...
        inner class `for læremidler` {
            @Test
            fun `fra AAP`() {
                assertThat(FaktiskMålgruppe.AAP.tilTypeAndel(Stønadstype.LÆREMIDLER)).isEqualTo(TypeAndel.LÆREMIDLER_AAP)
            }

            @Test
            fun `fra UFØRETRYGD`() {
                assertThat(FaktiskMålgruppe.UFØRETRYGD.tilTypeAndel(Stønadstype.LÆREMIDLER)).isEqualTo(TypeAndel.LÆREMIDLER_AAP)
            }
            ...
            fun `fra OVERGANGSSTØNAD`() {
                assertThat(
                    FaktiskMålgruppe.OVERGANGSSTØNAD.tilTypeAndel(Stønadstype.LÆREMIDLER),
            ...
            fun `fra OMSTILLINGSSTØNAD`() {
                assertThat(
                    FaktiskMålgruppe.OMSTILLINGSSTØNAD.tilTypeAndel(Stønadstype.LÆREMIDLER),
