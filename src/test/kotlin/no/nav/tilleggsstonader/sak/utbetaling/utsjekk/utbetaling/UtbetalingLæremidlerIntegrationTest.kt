...
class UtbetalingLæremidlerIntegrationTest : IntegrationTest() {
    @Autowired
    lateinit var fagsakUtbetalingsvalgService: FagsakUtbetalingsvalgService

    @Test
    fun `iverksetting for læremidler skal bruke gammelt fagområde når toggle er av`() {
    ...
    @Test
    fun `iverksetting for læremidler skal bruke nytt fagområde når toggle er på`() {
