    ...
    fun `skal ikke være mulig å sende inn kjørelister fremover i tid`() {
        ...
        kall.privatBil.apiRespons
            .lagreManuellKjøreliste(
                revurderingId,
                lagreRequest,
            ).expectProblemDetail(HttpStatus.BAD_REQUEST, "Kan ikke registrere kjøreliste for dager som er fremover i tid")
    }
    ...
    fun `skal ikke være mulig å registrere kjørelister for uker som alt er innsendt`() {
        ...
        kall.privatBil.apiRespons
            .lagreManuellKjøreliste(
                ...
                forventetDetail = "Følgende datoer er allerede registrert i en tidligere kjøreliste",
            )
    }
