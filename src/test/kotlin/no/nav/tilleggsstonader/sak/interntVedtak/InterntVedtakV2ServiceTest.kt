...
class InterntVedtakV2ServiceTest {
    ...
    private fun assertMålgrupper(målgrupper: List<VilkårperiodeInterntVedtakV2>) {
    ...
    private fun assertAktiviteter(aktiviteter: List<VilkårperiodeInterntVedtakV2>) {
