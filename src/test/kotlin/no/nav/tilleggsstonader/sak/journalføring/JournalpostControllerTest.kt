...
class JournalpostControllerTest : IntegrationTest() {
    ...
    inner class HentJournalpost {
        ...
        fun `hent journalpost som inneholder søknad daglig reise, kan kun opprette stønadstyper for daglig reise`() {
            ...
            JournalpostClientConfig.leggTilJournalpostMedSøknadIMock(journalpost, objectMapper.writeValueAsBytes(søknadDagligReise()))
        ...
        fun `hent journalpost som inneholder søknad boutgifter, kan kunn opprette stønadstype boutgifter`() {
            ...
            JournalpostClientConfig.leggTilJournalpostMedSøknadIMock(journalpost, objectMapper.writeValueAsBytes(søknadBoutgifter()))
