...
data class VedtaksperioderDvhV2(
    ...
    companion object {
        fun fraDomene(vedtak: Vedtak, barn: List<BehandlingBarn>): JsonWrapper {
            return when (val data = vedtak.data) {
                is InnvilgelseTilsynBarn, is OpphørTilsynBarn -> mapVedtaksperioderTilsynBarn(
        ...
        private fun mapVedtaksperioderLæremidler(beregningsresultat: BeregningsresultatLæremidler): JsonWrapper {
            return JsonWrapper(
                vedtaksperioder = VedtaksperiodeLæremidlerMapper
        ...
        private fun mapVedtaksperioderTilsynBarn(
            ...
            vedtaksperioder = VedtaksperiodeTilsynBarnMapper
                .mapTilVedtaksperiode(beregningsresultat.perioder)
                .map {
                    VedtaksperioderDvhV2(
                        fom = it.fom,
        ...
        fun List<BarnId>.finnFødselsnumre(barn: List<BehandlingBarn>) = this.mapNotNull { barnId ->
