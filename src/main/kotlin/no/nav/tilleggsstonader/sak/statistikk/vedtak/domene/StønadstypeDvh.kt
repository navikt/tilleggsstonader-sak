    ...
    companion object {
        fun fraDomene(stønadstype: Stønadstype): StønadstypeDvh =
            when (stønadstype) {
                ...
                Stønadstype.STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO -> STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO
                Stønadstype.STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR -> STØTTE_TIL_REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR
            }
    }
}
