...
class UtbetalingV3Mapper(
    ...
    private fun mapTilStønadUtbetaling(typeAndel: TypeAndel): StønadUtbetaling =
        when (typeAndel) {
            ...
            TypeAndel.REISE_TIL_SAMLING_TILTAK_ARBEIDSFORBEREDENDE -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_ARBEIDSFORBEREDENDE
            TypeAndel.REISE_TIL_SAMLING_TILTAK_ARBEIDSTRENING -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_ARBEIDSTRENING
            TypeAndel.REISE_TIL_SAMLING_TILTAK_AVKLARING -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_AVKLARING
            TypeAndel.REISE_TIL_SAMLING_TILTAK_ENKELTPLASS_AMO -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_ENKELTPLASS_AMO
            TypeAndel.REISE_TIL_SAMLING_TILTAK_ENKELTPLASS_FAG_YRKE_HOYERE_UTD ->
                StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_ENKELTPLASS_FAG_YRKE_HOYERE_UTD
            TypeAndel.REISE_TIL_SAMLING_TILTAK_GRUPPE_AMO -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_GRUPPE_AMO
            TypeAndel.REISE_TIL_SAMLING_TILTAK_GRUPPE_FAG_YRKE_HOYERE_UTD ->
                StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_GRUPPE_FAG_YRKE_HOYERE_UTD
            TypeAndel.REISE_TIL_SAMLING_TILTAK_HØYERE_UTDANNING -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_HØYERE_UTDANNING
            TypeAndel.REISE_TIL_SAMLING_TILTAK_JOBBKLUBB -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_JOBBKLUBB
            TypeAndel.REISE_TIL_SAMLING_TILTAK_OPPFØLGING -> StønadUtbetaling.REISE_TIL_SAMLING_TILTAK_OPPFØLGING
            ...
            TypeAndel.REISE_OPPSTART_TILTAK_ARBEIDSFORBEREDENDE -> StønadUtbetaling.REISE_OPPSTART_TILTAK_ARBEIDSFORBEREDENDE
            TypeAndel.REISE_OPPSTART_TILTAK_ARBEIDSTRENING -> StønadUtbetaling.REISE_OPPSTART_TILTAK_ARBEIDSTRENING
            TypeAndel.REISE_OPPSTART_TILTAK_AVKLARING -> StønadUtbetaling.REISE_OPPSTART_TILTAK_AVKLARING
            TypeAndel.REISE_OPPSTART_TILTAK_ENKELTPLASS_AMO -> StønadUtbetaling.REISE_OPPSTART_TILTAK_ENKELTPLASS_AMO
            TypeAndel.REISE_OPPSTART_TILTAK_ENKELTPLASS_FAG_YRKE_HOYERE_UTD ->
                StønadUtbetaling.REISE_OPPSTART_TILTAK_ENKELTPLASS_FAG_YRKE_HOYERE_UTD
            TypeAndel.REISE_OPPSTART_TILTAK_GRUPPE_AMO -> StønadUtbetaling.REISE_OPPSTART_TILTAK_GRUPPE_AMO
            TypeAndel.REISE_OPPSTART_TILTAK_GRUPPE_FAG_YRKE_HOYERE_UTD ->
                StønadUtbetaling.REISE_OPPSTART_TILTAK_GRUPPE_FAG_YRKE_HOYERE_UTD
            TypeAndel.REISE_OPPSTART_TILTAK_HØYERE_UTDANNING -> StønadUtbetaling.REISE_OPPSTART_TILTAK_HØYERE_UTDANNING
            TypeAndel.REISE_OPPSTART_TILTAK_JOBBKLUBB -> StønadUtbetaling.REISE_OPPSTART_TILTAK_JOBBKLUBB
            TypeAndel.REISE_OPPSTART_TILTAK_OPPFØLGING -> StønadUtbetaling.REISE_OPPSTART_TILTAK_OPPFØLGING
