...
data class InnvilgelseDagligReise(
    ...
    Innvilgelse {
    override val type: TypeVedtaksdata = TypeVedtakDagligReise.INNVILGELSE_DAGLIG_REISE
}
...
data class AvslagDagligReise(
    ...
    Avslag {
    override val type: TypeVedtaksdata = TypeVedtakDagligReise.AVSLAG_DAGLIG_REISE
...
data class OpphørDagligReise(
    ...
    Opphør {
    override val type: TypeVedtaksdata = TypeVedtakDagligReise.OPPHØR_DAGLIG_REISE
