package no.nav.tilleggsstonader.sak.vedtak.passAvBarn.beregning
...
import no.nav.tilleggsstonader.sak.vedtak.passAvBarn.beregning.PassAvBarnBeregningUtil.tilAktiviteterPerMånedPerType
import no.nav.tilleggsstonader.sak.vedtak.passAvBarn.beregning.PassAvBarnBeregningUtil.tilDagerPerUke
import no.nav.tilleggsstonader.sak.vedtak.passAvBarn.beregning.PassAvBarnBeregningUtil.tilÅrMåned
import no.nav.tilleggsstonader.sak.vedtak.passAvBarn.beregning.PassAvBarnBeregningValideringUtil.validerPerioderForInnvilgelse
...
import no.nav.tilleggsstonader.sak.vedtak.passAvBarn.domain.tilAktiviteter
...
@Service
class PassAvBarnBeregningService(
    private val vilkårperiodeRepository: VilkårperiodeRepository,
    private val vedtakRepository: VedtakRepository,
    private val passAvBarnUtgiftService: PassAvBarnUtgiftService,
    ...
    private fun beregnFra(
        ...
        val utgifterPerBarn = passAvBarnUtgiftService.hentUtgifterTilBeregning(behandling.id)
        ...
        return BeregningsresultatPassAvBarn(relevantePerioderFraForrigeVedtak + perioder)
    }

    private fun hentForrigeBeregningsresultat(behandling: Saksbehandling): BeregningsresultatPassAvBarn {
        ...
        return vedtakRepository
            ...
            .withTypeOrThrow<InnvilgelseEllerOpphørPassAvBarn>()
            .data
            .beregningsresultat
    }
