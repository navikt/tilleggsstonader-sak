...
fun Stønadstype.visningsnavnStønadsvilkår() =
    when (this) {
        ...
        Stønadstype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSO -> "støtte til reise ved oppstart, avslutning og hjemreise"
        Stønadstype.REISE_OPPSTART_AVSLUTNING_HJEMREISE_TSR -> "støtte til reise ved oppstart, avslutning og hjemreise"
    }
