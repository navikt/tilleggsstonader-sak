    ...
    private fun lagreAndeler(
        ...
        val andeler = beregningsresultat.perioder.groupBy { it.grunnlag.utbetalingsmåned }
            ...
            .map { (utbetalingsmåned, perioder) ->
                ...
                // TODO vi må kunne støtte ulike målgrupper som betales ut samtidig
                ...
                // TODO eller første dagen for utbetalingsmåned?
                // TODO andel skal validere lør/søn for læremidler
                val minFom = perioder.minOf { it.grunnlag.fom }
                val fom = minFom.datoEllerNesteMandagHvisLørdagEllerSøndag()
                AndelTilkjentYtelse(
