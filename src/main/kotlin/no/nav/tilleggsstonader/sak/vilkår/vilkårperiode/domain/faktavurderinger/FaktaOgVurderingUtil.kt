...
object FaktaOgVurderingUtil {
    inline fun <reified T : Vurderinger> Vurderinger.takeIfVurderinger() = takeIf { it is T }?.let { it as T }

    inline fun <reified T : Fakta> Fakta.takeIfFakta() = takeIf { it is T }?.let { it as T }
