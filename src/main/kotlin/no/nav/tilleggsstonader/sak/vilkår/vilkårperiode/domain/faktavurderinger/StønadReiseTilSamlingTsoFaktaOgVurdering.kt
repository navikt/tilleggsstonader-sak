...
data class TiltakReiseTilSamlingTso(
    ...
    override val fakta: FaktaAktivitetReiseTilSamlingTso,
...
data class FaktaAktivitetReiseTilSamlingTso(
    override val aktivitetsdager: Int? = null, // TODO høre om denne skal fjernes
) : Fakta,
