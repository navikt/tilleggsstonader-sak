...
@JsonSubTypes(
    ...
    JsonSubTypes.Type(NedsattArbeidsevneTilsynBarn::class, name = "AAP_TILSYN_BARN"),
    ...
    JsonSubTypes.Type(NedsattArbeidsevneTilsynBarn::class, name = "UFØRETRYGD_TILSYN_BARN"),
