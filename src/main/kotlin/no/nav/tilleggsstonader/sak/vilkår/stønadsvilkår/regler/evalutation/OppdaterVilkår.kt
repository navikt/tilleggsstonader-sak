...
object OppdaterVilkår {
    ...
    fun oppdaterVilkår(
        ...
        return vilkår.copy(
            ...
            offentligTransport = oppdatering.offentligTransport.mapOffentligTransportDto(),
        )
    }
    ...
    private fun OffentligTransportDto?.mapOffentligTransportDto(): OffentligTransport? {
