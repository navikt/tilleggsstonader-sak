...
class VilkårService(
    ...
    fun oppdaterVilkår(svarPåVilkårDto: SvarPåVilkårDto): VilkårDto {
        ...
        validerEndrePeriodeIForholdTilRevurderFra(behandling, vilkår, oppdatertVilkår)
    ...
    fun opprettNyttVilkår(opprettVilkårDto: OpprettVilkårDto): Vilkår {
        ...
        validerNyPeriodeIForholdTilRevurderFra(behandling, oppdatertVilkår)
    ...
    fun slettVilkår(oppdaterVilkårDto: OppdaterVilkårDto) {
        ...
        val behandling = behandlingService.hentSaksbehandling(behandlingId)
        validerBehandling(behandling)
        validerSlettPeriodeIForholdTilRevurderFra(behandling, vilkår)
