...
object SøknadsskjemaPassAvBarnMapper {
    fun map(
        ...
        SøknadPassAvBarn(
            ...
            språk = språk,
            data = mapSkjemaPassAvBarn(skjema, journalpost),
            barn = mapBarn(skjema),
        )
                        ...
                        BarnMedBarnepass(
                            ...
                            utgifter =
                                it.utgifter?.let { utgifter ->
                                    Utgifter(
                                        harUtgifterTilPassHelePerioden = utgifter.harUtgifterTilPassHelePerioden.verdi,
